...
class hotvideo(BaseModel):
    ...
    publocation=models.CharField ( max_length=255, null=True, unique=False, verbose_name='上传地点' )
    pubtime=models.CharField ( max_length=255, null=True, unique=False, verbose_name='上传时间' )
    ...
    coin=models.IntegerField  (  null=True, unique=False, verbose_name='投币' )
...
class hotvideoforecast(BaseModel):
    __doc__ = u'''hotvideoforecast'''
    __tablename__ = 'hotvideoforecast'
    ...
    '''
    class Meta:
        db_table = 'hotvideoforecast'
        verbose_name = verbose_name_plural = '热门视频预测'
...
class discusshotvideo(BaseModel):
    __doc__ = u'''discusshotvideo'''
    __tablename__ = 'discusshotvideo'
    ...
    '''
    class Meta:
        db_table = 'discusshotvideo'
        verbose_name = verbose_name_plural = 'hotvideo评论表'
